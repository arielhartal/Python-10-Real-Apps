...
function Run()
{
		...
		DoCmd("play obj=MarvinSceneParent pkg=http://www.warnerbros.com/marvin/assets/episode02/stream1PKG.pws transition=0.30 heading=yes behave=stream1");
		//chgImg(1, "start");
...
function Interact()
{
	CURRENT_SEGMENT = SEGMENT_2;
 	DoCmd("play obj=MarvinSceneParent pkg=http://www.warnerbros.com/marvin/assets/episode02/stream2PKG.pws transition=0.30 heading=yes behave=stream2");
}
  ...
  <tr>
      <table width="320" border="0" cellspacing="0" cellpadding="0">
        <tr>
		 ...
		 <PARAM NAME="URL" VALUE="http://www.warnerbros.com/marvin/assets/episode02/marvin.pwc">
		...
		<EMBED NAME="Ctrl" MAYSCRIPT SRC="http://www.warnerbros.com/marvin/assets/episode02/marvin.pwc" WIDTH=640 HEIGHT=480 FRAMERATE=30 HARDWARE=1
        ...
        <tr>
            <td><a href="javascript:Run()" onClick="Run();return false" onMouseOut="imgOff('playplay')" onMouseOver="imgOn('playplay'),window.status='play the episode';return true"><p name="playplay" alt="run" border="25">Play</p></a></td>
            <td><a href="javascript:Interact()" onClick="Interact();return false;"><p width="100" height="100" name="interact" alt="action" border="25" style="text-align:right;">Teleport</p></a></td>
        </tr>
      </table>
  </tr>
</table>
