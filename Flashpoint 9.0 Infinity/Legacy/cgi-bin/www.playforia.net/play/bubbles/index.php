...
?>
<applet id="gameclient" class="java topspacer" codebase="http://game21.playforia.net/Poks3/" code="Poks3" archive="Poks3.jar,/Shared/HackedShared.zip" width="645" height="465"> 
	...
	<param name="userlistpage" value="javascript:Playray.GameFaceGallery('%n','#511D1D','poks3','%s')" /> 
	...
	<param name="tellfriendpage" value="http://www.playforia.net/q/tellfriend/bubbles" /> 
	<param name="tellfriendtarget" value="tellfriend" /> 
	<param name="tellfriend" value="1" />

	<param name="flashpoint_products" value="4	helperaimer	1	0	0	0	helperundo	1	0	0	0	helpercolor	1	0	0	0	helperballs	1	0	0	0" />
</applet>