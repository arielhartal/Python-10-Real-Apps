...
?>
<applet id="gameclient" class="java topspacer" codebase="http://game21.playforia.net/Defence2/" code="Defence2" archive="Defence2.jar,/Shared/HackedShared2.zip" width="760" height="520"> 
	...
	<param name="userlistpage" value="javascript:Playray.GameFaceGallery('%n','#000000','defence2','%s')" /> 
	...
	<param name="tellfriendpage" value="http://www.playforia.net/q/tellfriend/superdefence" /> 
