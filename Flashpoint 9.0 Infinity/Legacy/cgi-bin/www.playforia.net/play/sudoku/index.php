...
?>
<applet id="gameclient" class="java topspacer" codebase="http://game21.playforia.net/Sudoku/" code="Sudoku" archive="Sudoku.jar,/Shared/HackedShared.zip" width="610" height="375"> 
	...
	<param name="userlistpage" value="javascript:Playray.GameFaceGallery('%n','#835C41','sudoku','%s')" /> 
	...
	<param name="tellfriendpage" value="http://www.playforia.net/q/tellfriend/sudoku" /> 
