...
?>
<applet id="gameclient" class="java topspacer" codebase="http://game21.playforia.net/Separator/" code="Separator" archive="Separator.jar,/Shared/HackedShared.zip" width="740" height="440"> 
	...
	<param name="userlistpage" value="javascript:Playray.GameFaceGallery('%n','#4A3B3B','separator','%s')" /> 
	...
	<param name="tellfriendpage" value="http://www.playforia.net/q/tellfriend/separator" /> 
