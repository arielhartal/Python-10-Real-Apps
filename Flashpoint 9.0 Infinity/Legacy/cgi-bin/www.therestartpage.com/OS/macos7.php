...
<style type="text/css">
	...
	#os7_bootup_1 {
			...
			width: 100%;
			height:100%;
			background: url(OS/media/macos7/bg.gif) repeat;
			top:0;
			left:0;
			position: absolute;
	}
	...
	#os7_bootup_2 {
			...
			float: left;
			background-image: url(OS/media/macos7/bg1.gif);
	...
	.top {
			background-image: url(OS/media/macos7/loading.gif);
	...
	.weemac {
			background-image: url(OS/media/macos7/icon_loading.gif);
			background-repeat: no-repeat;
			height: 100%;
			width: 100%;
			float: left;
	...
	.loading {
		background-image: url(OS/media/macos7/splash_loading.gif);
		background-repeat: no-repeat;
		z-index: 10;
		height: 100%;
		width: 100%;
	...
	.icons {
		background-image: url(OS/media/macos7/icons.gif);
		background-repeat: no-repeat;
		height: 42px;
		width: 402px;
		position: absolute;
