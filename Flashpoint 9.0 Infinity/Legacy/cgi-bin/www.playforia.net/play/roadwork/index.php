...
?>
<applet id="gameclient" class="java topspacer" codebase="http://game21.playforia.net/RoadWork/" code="RoadWork" archive="RoadWork.jar,/Shared/HackedShared.zip" width="600" height="350"> 
	...
	<param name="userlistpage" value="javascript:Playray.GameFaceGallery('%n','#99CCCC','roadwork','%s')" /> 
	...
	<param name="tellfriendpage" value="http://www.playforia.net/q/tellfriend/roadwork" /> 
