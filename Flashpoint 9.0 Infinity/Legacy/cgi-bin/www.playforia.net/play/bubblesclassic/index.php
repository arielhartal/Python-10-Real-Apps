...
?>
<applet id="gameclient" class="java topspacer" codebase="http://game21.playforia.net/Poks/" code="Poks" archive="Poks.jar,/Shared/HackedShared.zip" width="645" height="465"> 
	...
	<param name="userlistpage" value="javascript:Playray.GameFaceGallery('%n','#FFCCCC','poks','%s')" /> 
	...
	<param name="superpoks" value="http://www.playforia.net/play/superbubbles" />
	<param name="session" value="SjogTxTF-SsojJVoWUa9diQcQTf" /> 
	<param name="sessionlocale" value="en" /> 
	<param name="tellfriendpage" value="http://www.playforia.net/q/tellfriend/bubblesclassic" /> 
	<param name="tellfriendtarget" value="tellfriend" /> 
	<param name="tellfriend" value="1" />

	<param name="flashpoint_products" value="1	playtime	5	0	0	0" />
</applet>