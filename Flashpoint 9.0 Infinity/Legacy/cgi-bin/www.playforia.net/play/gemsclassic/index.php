...
?>
<applet id="gameclient" class="java topspacer" codebase="http://game21.playforia.net/Gems/" code="Gems" archive="Gems.jar,/Shared/HackedShared.zip" width="645" height="430"> 
	...
	<param name="userlistpage" value="javascript:Playray.GameFaceGallery('%n','#01264B','gems','%s')" /> 
	...
	<param name="tellfriendpage" value="http://www.playforia.net/q/tellfriend/gemsclassic" /> 
