	...
	<style type="text/css">
		...
		#win2000_sd {position:absolute;top:50%;left:50%;height:144px;width:417px;margin:-72px 0 0 -208.5px;background:url('OS/media/win2000/shutting_2000.gif') no-repeat 0 0;}
		...
		#bios_tl_2 {display:none;position:absolute;display:none;top:0;left:0;height:600px;width:900px;background:url('OS/media/DOS/bios-start_01.gif') no-repeat 0 0;}
		...
		#win2000_start { display:none;position:absolute;top:50%;left:50%;height:100%;width:900px;margin:-337.5px 0 0 -450px;background:url('OS/media/win98/loading_win98.gif') no-repeat 0 0; }
		#win2000_load { position:absolute;bottom:0px;left:50%;height:120px;width:900px;margin:0 0 0 -450px;background:url('OS/media/win2000/win2000_dos_loading.gif') no-repeat 0 0; }
		#win2000_splash {position:absolute;top:50%;left:50%;height:500px;width:900px;margin:-250px 0 0 -450px;background:url(OS/media/win2000/windows2000_splash.gif) no-repeat 0 0; }
		#win2000_bt_splash { position:absolute;padding-top:16px;background:url(OS/media/win2000/windows2000_splash_loading.gif) repeat-x top center #c3c3c3;bottom:0px;left:0px;width:100%;text-align:center;}
		#win2000_loading {position:absolute;top:50%;left:50%;height:144px;width:417px;margin:-72px 0 0 -208.5px;background:url('OS/media/win2000/starting_2000.gif') no-repeat 0 0; }
	...
	<script type="text/javascript">
		$(function(){
			...
			setTimeout(function(){$('#bios_tr,#bios_bl,#bios_tl').hide().remove();$('#bios_tl_2').show();play('OS/bios.wav');},12800);
			...
			/*setTimeout(function(){play('media/win98/login.wav');},13000);
			...
			setTimeout(function(){play('OS/media/win2000/login.wav');},41000);
