...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		...
		<title>Sign-up - Tetris Friends</title>
		<meta name="description" content="Sign-up for a FREE account on Tetris Friends Online Games. Use your Facebook ID for easy access!" />
		...
		<script language="javascript" type="text/javascript">
			<!--
			OAS_INIT('x54', 'XE&amp;status=active&amp;ar=-1&amp;gg=-1&amp;us=0&amp;XE', 'home', jsVersion);
			checkGuest('155.4.246.168', 'www.tetrisfriends.com', '/users/register.php?saveGame=true', '1557424014948');
			-->
		</script>
                ...
                optionalCookies: [
                    {
                        ...
                        onAccept: function() {
                            window.fbAsyncInit = function() {
                            	initFBConnect("135520563131905","","",false,false,"4cf624c7464d952fd2d06ca6a11b38e6","http://www.tetrisfriends.com");
                            };
...
-->
   ...
   <a href="javascript:void(0)" class="fbconnect_login_button" disabled title="Please enable Social Plugin Cookies to use this feature!" style="filter: gray; -webkit-filter: grayscale(1); -webkit-filter: grayscale(100%); filter: grayscale(1); filter: grayscale(100%);"></a>							</div>
		...
		<div id="wrapper" class="reg_wrapper">
			<!--
			...
			<!-- modified container -->
			<div style="margin-left:0px; margin-right:0px; width:auto; height:auto;">
			<div id="container" style="position: relative;">
				<!-- Registration page specific code -->

				<?php include '_inc/_registerForm.php'; ?>
		...
		</script>	<script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"bam.nr-data.net","licenseKey":"0db427ec08","applicationID":"12597004","transactionName":"YAZSZkBSXhZYWhAKC1lMZUBbHEUWXEsXTBZSBFlBRlZCS0lRFA==","queueTime":0,"applicationTime":6,"atts":"TEFREAhITRg=","errorBeacon":"bam.nr-data.net","agent":""}</script></body>
</html>
