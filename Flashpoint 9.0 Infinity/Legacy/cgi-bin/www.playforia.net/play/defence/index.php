...
?>
<applet id="gameclient" class="java topspacer" codebase="http://game21.playforia.net/Defence/" code="Defence" archive="Defence.jar,/Shared/HackedShared.zip" width="720" height="430"> 
	...
	<param name="userlistpage" value="javascript:Playray.GameFaceGallery('%n','#000000','defence','%s')" /> 
	...
	<param name="tellfriendpage" value="http://www.playforia.net/q/tellfriend/defence" /> 
	<param name="tellfriendtarget" value="tellfriend" /> 
	<param name="buylevels" value="15,10,5,3" />
</applet>