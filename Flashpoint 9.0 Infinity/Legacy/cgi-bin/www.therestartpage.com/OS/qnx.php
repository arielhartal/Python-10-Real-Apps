...
html, body, #container {
		...
		cursor:url(OS/media/qnx/blank.gif), -moz-zoom-in;
		}
...
body {
	...
	float: left;
	background-image: url(OS/media/qnx/qnx-bios-start_01.gif);
...
.top {
	background-image: url(OS/media/qnx/bios_splash.gif);
	background-repeat: no-repeat;
	height: 500px;
	width: 100%;
	float: left;
...
.bottom {
	...
	position: absolute;
	bottom: 20px;
	background-image: url(OS/media/qnx/bios_bottom.gif);
	background-repeat: no-repeat;
...
.bg {
	...
	position: absolute;
	z-index: -2;
	background-image: url(OS/media/qnx/bg.gif);
	}
