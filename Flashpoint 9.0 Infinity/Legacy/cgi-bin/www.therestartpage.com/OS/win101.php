...
<script type="text/javascript" src="http://restart.dev.rehabstudio.com/scripts/jquery-1.4.3.min.js"></script>
	<style type="text/css">
		...
		#win_dos { position:absolute;top:0px;left:0px;background:url(OS/media/win101/a_blink.gif) no-repeat 0 0;height:300px;width:700px;s }
		#win_dos_2 { position:absolute;top:0px;left:0px;background:url(OS/media/win101/dos_win_01.gif) no-repeat 0 0;height:300px;width:700px;}
		#win_dos_2_2 { position:absolute;top:0px;left:0px;background:url(OS/media/win101/bios-start_02.gif) no-repeat 0 0;height:600px;width:900px;}
		#win_dos_3 { position:absolute;width:640px;height:400px;left:50%;top:50%;margin:-200px 0 0 -320px;background:url(OS/media/win101/splash_Windows-1.gif) no-repeat 0 0; }
