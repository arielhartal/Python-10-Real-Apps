...
?>
<applet id="gameclient" class="java topspacer" codebase="http://game21.playforia.net/Worm/" code="Worm" archive="Worm.jar,/Shared/HackedShared.zip" width="740" height="440"> 
	...
	<param name="userlistpage" value="javascript:Playray.GameFaceGallery('%n','#008357','worm','%s')" /> 
	...
	<param name="tellfriendpage" value="http://www.playforia.net/q/tellfriend/serpent" /> 
