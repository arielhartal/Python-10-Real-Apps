...
?>
<applet id="gameclient" class="java topspacer" codebase="http://game21.playforia.net/LightsOn/" code="LightsOn" archive="LightsOn.jar,/Shared/HackedShared.zip" width="700" height="450"> 
	...
	<param name="userlistpage" value="javascript:Playray.GameFaceGallery('%n','#170C1D','lightson','%s')" /> 
	...
	<param name="tellfriendpage" value="http://www.playforia.net/q/tellfriend/stagelights" /> 
