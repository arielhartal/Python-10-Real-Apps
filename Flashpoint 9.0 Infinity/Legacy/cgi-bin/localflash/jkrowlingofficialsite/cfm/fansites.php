...
<?php } elseif($lang == "it" ){?>
<x><rs n="fansites" c="winner,archive,abouttitle,aboutcontent"><r><c n="winner"><![CDATA[Ultimo vincitore]]></c><c n="archive"><![CDATA[Archivio]]></c><c n="abouttitle"><![CDATA[Info]]></c><c n="aboutcontent"><![CDATA[È sinceramente commovente vedere quanti fan hanno passato tempo a creare dei siti dedicati a Harry Potter. Ecco perché ho creato il Fan Site Award, un premio dato per l'incredibile devozione e per la conoscenza su Harry Potter, senza contare l'ingegno e la creatività che rendono un sito memorabile.]]></c></r></rs><rs n="winner" c="ID,m,t,c,i,url,sp"><r><c n="ID"><![CDATA[3]]></c><c n="m"><![CDATA[12]]></c><c n="t"><![CDATA[Leaky Cauldron]]></c></r></rs></x>
<?php } else {?>
