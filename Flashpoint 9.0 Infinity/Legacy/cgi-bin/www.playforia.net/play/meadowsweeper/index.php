...
?>
<applet id="gameclient" class="java topspacer" codebase="http://game21.playforia.net/MineRake/" code="MineRake" archive="MineRake.jar,/Shared/HackedShared.zip" width="760" height="410"> 
	...
	<param name="userlistpage" value="javascript:Playray.GameFaceGallery('%n','#D2D2B0','minerake','%s')" /> 
	...
	<param name="tellfriendpage" value="http://www.playforia.net/q/tellfriend/meadowsweeper" /> 
