...
?>
<applet id="gameclient" class="java topspacer" codebase="http://game21.playforia.net/SpaceCave/" code="SpaceCave" archive="SpaceCave.jar,/Shared/HackedShared.zip" width="620" height="400"> 
	...
	<param name="userlistpage" value="javascript:Playray.GameFaceGallery('%n','#000000','spacecave','%s')" /> 
	...
	<param name="tellfriendpage" value="http://www.playforia.net/q/tellfriend/spacecave" /> 
